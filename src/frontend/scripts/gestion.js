...
const response = fetch("http://192.168.1.31:5000/api/product/idVendor/"+idVendor_cookie, {
          ...
          <div class="row g-0">
            ...
            <div class="col-sm-8">
              <div class="card-body">
                ...
                <a href="modifierMeuble.html?id=${element._id}" type="button" class="btn btn-secondary">Modifier</a>
              </div>
            </div>
          </div>
        </div>
